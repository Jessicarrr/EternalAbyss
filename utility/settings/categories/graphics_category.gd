...
var film_grain_gameplay : BoolSetting = BoolSetting.new(
		"Film Grain - Gameplay",
		"Adds a TV static like effect to the screen, which will only show during relevant gameplay events.",
		true
)
var film_grain_gameplay_intensity : NumberRangeSetting = NumberRangeSetting.new(
		"Film Grain - Gameplay Intensity",
